...
#define CUT_POINTS_CROSSOVER 2 /* se este valor for 0 ou maior que a dimensão dos individuos - 2, faz-se crossover uniforme*/
#define TOURNAMENT_SAMPL 0 /* se este valor for 0 ou maior que POPULATION_SIZE, todos os individuos participam do torneio*/
#define GENERATIONS 1000
#define SELECTION_OPT false /* true -> seleção por torneio, false -> seleção por roleta viciada */
